...
public class ConfigValues {
    ...
    public void loadConfigFile() {
        ...
        ENABLE_IRON_WAND = configFile
                ...
                .getBoolean();
        ENABLE_DIAMOND_WAND = configFile.get(
                CONFIG_GENERAL,
                ENABLE_DIAMOND_WAND_NAME,
                ENABLE_DIAMOND_WAND_DEFAULT,
                ENABLE_DIAMOND_WAND_DESCRIPTION).getBoolean();
        ...
        DIAMOND_WAND_DURABILITY = configFile.get(
                DIAMOND_WAND_DURABILITY_NAME,
                CONFIG_GENERAL,
                DIAMOND_WAND_DURABILITY_DEFAULT,
                DIAMOND_WAND_DURABILITY_DESCRIPTION).getInt();
